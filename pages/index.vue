<template>
  <div class="container">
    ...
    <div class="row">
      <div v-for="post in posts" :key="post.url_slug" class="col-md-4">
          <div class="card mb-4 shadow-sm">
            ...
            <div class="card-body">
              ...
              <span v-for="t in post.tag">
                <nuxt-link :to="`/tags/${t}`" class="mr-1 badge badge-info">#{{ t }}</nuxt-link>
              </span>
              </div>
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  <nuxt-link :to="`/posts/${post.url_slug}`" class="btn btn-sm btn-outline-secondary">Подробнее</nuxt-link>
                </div>
